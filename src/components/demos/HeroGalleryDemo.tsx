      ...
      <Protect plan="premium" fallback={
        ...
        <div className="h-[100vh] relative">
          <motion.footer 
            ...
            className={`${showFooter ? 'fixed' : 'absolute -bottom-full'} bottom-0 left-0 right-0 w-full bg-background pt-16 pb-8 shadow-[0_-10px_30px_rgba(0,0,0,0.1)] z-10 transition-all duration-500`}
          >
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                <div className="mb-8 md:mb-0">
                  <h3 className="mb-4 text-2xl font-serif font-bold text-primary">ChefMate</h3>
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a href="#" className="footer-social-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
                    </a>
                  </div>
                  <div className="mt-4">
                    <p className="text-sm text-muted-foreground">Subscribe to our newsletter</p>
                    <div className="mt-2 flex">
                      <input type="email" placeholder="Your email" className="flex-1 rounded-l-md border px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary" />
              ...
              <div className="mt-12 border-t pt-8">
                <div className="flex flex-col md:flex-row justify-between items-center">
                  <p className="text-sm text-muted-foreground">&copy; 2025 ChefMate Ltd. All rights reserved.</p>
                  <div className="flex mt-4 md:mt-0 space-x-6 footer-links">
